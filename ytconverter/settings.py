""""
Django settings for ytconverter project.
...
SECRET_KEY = '(36^$tx4%d*-%l$)o*(5ir-jyuah-kkyx6vlag%s^@wjoxnaia'
...
WSGI_APPLICATION = 'ytconverter.wsgi.application'
...
BROKER_URL = os.getenv('BROKER_URL', 'amqp://guest:guest@rabbit:5672//')
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'annaroot16@gmail.com'
